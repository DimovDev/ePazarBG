 ...
 */
final class Version20181215062717 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD price DOUBLE PRECISION NOT NULL, DROP category');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP price');
    }
}
