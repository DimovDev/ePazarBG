 ...
 */
final class Version20181212155352 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE dateAdded dateAdded DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE dateAdded dateAdded DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
